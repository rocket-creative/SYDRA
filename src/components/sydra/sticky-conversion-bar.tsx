...
export function StickyConversionBar({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 pb-safe-bottom pl-[max(0px,env(safe-area-inset-left))] pr-[max(0px,env(safe-area-inset-right))] lg:hidden" data-sticky-cta>
