...
const props = [
  {
    title: "Faster",
    body: "30 minutes per claim down to under 5. Your billing team gets their afternoons back.",
  },
  {
    title: "Smarter",
  ...
  {
    title: "Yours",
    body: "Your team owns the workflow. No vendor in the loop. Or add Kronos Support if you want backup on tricky cases.",
  },
] as const;
