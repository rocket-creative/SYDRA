    ...
    <>
      ...
      <SydraPageShell banded breadcrumb={[...BREADCRUMBS.contact]} hasMobileCtaBar>
        <div className="flex flex-col">
          ...
          <Section className="order-2 lg:order-3" sidebarLabel="Get in touch" tone="white">
            <section aria-labelledby="heading-contact-form" className="prose-measure" id="contact-form">
              <h2 className={textStyles.sectionTitle} id="heading-contact-form">
                Set up a demo or ask a question.
              </h2>
            ...
            <div className="space-y-8 prose-measure">
              <section aria-labelledby="routing-new">
                ...
                <p className={`${textStyles.body} mt-2`}>
                  Use the form above or email {salesEmail}. Response within one business day.
              ...
              <section aria-labelledby="routing-procurement">
                ...
                <p className={`${textStyles.body} mt-2`}>
                  ...
                  package request. We send the BAA template, security one pager, and subprocessor list
          ...
          <Section className="order-4" tone="neutral">
      ...
      <StickyConversionBar primaryLabel="Contact us" scrollTargetId="contact-form" />
    </>
  );
}
