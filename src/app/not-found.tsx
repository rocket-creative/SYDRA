...
export const metadata = buildPageMetadata({
  ...
  description:
    "The page you requested wasn't found on the Sydra marketing site. Return to the homepage or set up a 15-minute call to see what federal IDR would do with one of your denied claims.",
  path: "/404",
      ...
      <div className="px-6 py-20 md:px-10 md:py-28">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mt-6 type-body text-body">
            That URL isn&apos;t on this site. Head back to the homepage, or set up a 15-minute call
