/**
 * Reusable copy constants for the pain first catalog (build spec section 8).
 *
 * These four blocks are SAME on every catalog page. They are George's voice:
 * generalized, best case framed, honest, and carry no per page numbers. Do not
