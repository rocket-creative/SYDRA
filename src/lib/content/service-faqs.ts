...
export const PRICING_FAQ: ServiceFaqItem[] = [
  ...
  },
  {
    ...
    a: "For a practice with 20 claims per month, $15,000 average disputed amount, 88% win rate: a typical 20% contingency: $633,600 in annual fees on recoveries. Sydra per claim and subscription models rather than a percentage of recovery: quoted to your volume, structured below that figure. The exact comparison is part of what we show you on the demo call.",
  },
];
