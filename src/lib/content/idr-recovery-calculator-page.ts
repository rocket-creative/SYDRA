...
export const IDR_RECOVERY_CALCULATOR_HERO = {
  ...
  lead: "Enter monthly out of network claim volume and average disputed amount. Uses published CMS win rates and Georgetown CHIR award benchmarks, not a Sydra performance claim.",
};
...
export const IDR_RECOVERY_CALCULATOR_SECTIONS: ContentSection[] = [
  {
    ...
    paragraphs: [
      "Estimated annual recovery = monthly eligible claims × average disputed amount × 12 × 88 percent (the published CMS and Georgetown win rate for properly filed disputes).",
...
export const IDR_RECOVERY_CALCULATOR_FAQS: ContentFaq[] = [
  {
    ...
    a: "It estimates annual recovery and the portion a typical 20 percent contingency attorney would keep, using published provider win rates and award multiples from CMS Public Use Files and Georgetown CHIR analysis. It is an illustration for planning, not a promise for any single claim.",
  },
  {
