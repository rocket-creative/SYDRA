...
export const IDR_FOR_BILLING_HERO = {
  ...
  ctaLabel: "Book your free five minute demo",
  ctaHref: "/demo",
};
...
export const IDR_FOR_BILLING_CTA_LEAD =
  "Free five minute demo. No commitment. Bring a real claim from any specialty in your book and we'll show you what Sydra generates, and talk through how the account structure fits a multi client firm.";

export const IDR_FOR_BILLING_CTA_BAND = {
  title: "Ready to see Sydra on a real denied claim from one of your client practices?",
  lead: "Free five minute demo. No commitment. Bring a real claim from any specialty in your book and we'll show you what Sydra generates, and talk through how the account structure fits a multi client firm.",
  ctaLabel: "Book your free five minute demo",
};
