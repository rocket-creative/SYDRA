...
export function buildFaqs(stateDisplay: string | null) {
  ...
  return [
    ...
    {
      q: stateQuestion,
      a: `We are live or rolling out in ${LAUNCH_STATES_DISPLAY} for 2026. Request a 15-minute demo and we will confirm pathway coverage for your practice location and payer mix.`,
    },
  ] as const;
}
