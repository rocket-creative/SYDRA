    ...
    <section className="border-b border-slate-100 bg-white py-14 md:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 xl:max-w-[1200px] xl:px-8">
        ...
        <p className="mt-6 max-w-3xl text-base leading-relaxed text-[#4A5568] md:text-[17px] md:leading-[1.75]">
          The No Surprises Act gave providers the right to dispute these payments
          through Independent Dispute Resolution, but writing a winning IDR
          submission takes hours of clinical, financial, and legal work for every
          case. Most practices either skip it or pay a billing service 30% or
          more of recovered revenue.
        </p>
        <p className="mt-6 max-w-3xl text-base font-medium leading-relaxed text-[#4A5568] md:text-[17px]">
